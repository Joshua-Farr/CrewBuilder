...
import { withLocalDevFakeDecks, withLocalDevFakeTournaments } from "@/lib/local-dev/fake-event";
...
export const decks: Deck[] = withLocalDevFakeDecks([...sampleDecks, ...op15Decks, ...egmanDecks]);
const sampleTournaments: Tournament[] = [
 { id: "t-na-nationals-2026", name: "North America Treasure Cup Finals", slug: "north-america-treasure-cup-finals-2026", region: "NA", format: "Constructed", opSet: "OP08", date: "2026-05-18", players: 512, location: "Chicago, IL", winnerDeckId: "deck-purple-luffy-nationals", winningLeaderId: "op05-060", winningLeaderName: "Monkey D. Luffy", topCutDeckIds: ["deck-purple-luffy-nationals", "deck-lucci-online-open", "deck-zoro-regional"], bracketSummary: "Purple Luffy defeated Black Lucci 2-1 after stabilizing game three with back-to-back ramp turns.", deckDistribution: [{ leaderId: "op05-060", leaderName: "Monkey D. Luffy", count: 94 }, { leaderId: "op07-079", leaderName: "Rob Lucci", count: 88 }, { leaderId: "op06-001", leaderName: "Roronoa Zoro", count: 61 }], stats: { totalMatches: 1492, conversionRate: 18.4, rogueShare: 22.8 } },
 { id: "t-eu-online-open-2026", name: "EU Online Championship", slug: "eu-online-championship-2026", region: "EU", format: "Constructed", opSet: "OP08", date: "2026-05-12", players: 384, location: "Online", winnerDeckId: "deck-lucci-online-open", winningLeaderId: "op07-079", winningLeaderName: "Rob Lucci", topCutDeckIds: ["deck-lucci-online-open", "deck-katakuri-store-champ"], bracketSummary: "A removal-heavy Lucci build posted the best Swiss record before falling in finals.", deckDistribution: [{ leaderId: "op07-079", leaderName: "Rob Lucci", count: 76 }, { leaderId: "op08-058", leaderName: "Charlotte Katakuri", count: 54 }, { leaderId: "op05-060", leaderName: "Monkey D. Luffy", count: 49 }], stats: { totalMatches: 1101, conversionRate: 15.9, rogueShare: 26.1 } },
 { id: "t-latam-regional-2026", name: "LATAM Regional Qualifier", slug: "latam-regional-qualifier-2026", region: "LATAM", format: "Constructed", opSet: "OP08", date: "2026-05-09", players: 256, location: "Sao Paulo, BR", winnerDeckId: "deck-zoro-regional", winningLeaderId: "op06-001", winningLeaderName: "Roronoa Zoro", topCutDeckIds: ["deck-zoro-regional", "deck-purple-luffy-nationals"], bracketSummary: "Zoro tempo converted the best top-cut rate by pressuring slower ramp decks.", deckDistribution: [{ leaderId: "op06-001", leaderName: "Roronoa Zoro", count: 51 }, { leaderId: "op05-060", leaderName: "Monkey D. Luffy", count: 42 }, { leaderId: "op08-058", leaderName: "Charlotte Katakuri", count: 33 }], stats: { totalMatches: 739, conversionRate: 20.1, rogueShare: 28.5 } }
];
const baseTournaments: Tournament[] = [...sampleTournaments, ...op15Tournaments, ...egmanTournaments];
export const tournaments: Tournament[] = withLocalDevFakeTournaments(baseTournaments);
