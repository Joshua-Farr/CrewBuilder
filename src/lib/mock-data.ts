...
const sampleTournaments: Tournament[] = [
 ...
 { id: "t-vod-test-2026", name: "VOD Test Event", slug: "vod-test-event-2026", region: "NA", format: "Constructed", opSet: "OP08", date: "2026-05-29", players: 128, location: "Local Test", winnerDeckId: "deck-purple-luffy-nationals", winningLeaderId: "op05-060", winningLeaderName: "Monkey D. Luffy", topCutDeckIds: ["deck-purple-luffy-nationals"], bracketSummary: "Local test event for verifying the event VOD link.", deckDistribution: [{ leaderId: "op05-060", leaderName: "Monkey D. Luffy", count: 24 }], stats: { totalMatches: 384, conversionRate: 12.5, rogueShare: 18.0 }, vodUrl: "https://www.youtube.com/watch?v=FjYpPdeF8EU" }
];
